...
**Целевой файл:** `api/v1/world/mentorship/effects.yaml`
...
**Файл:** `api/v1/world/mentorship/effects.yaml`  
...
1. `api/v1/world/mentorship/effects.yaml` создан/обновлён и проходит `scripts/validate-swagger.ps1`.  
