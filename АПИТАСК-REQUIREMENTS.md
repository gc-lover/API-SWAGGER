...
- Примеры именования при разбиении:
  - `resource-name.yaml` (главный файл с info, servers, ссылки на остальные)
  - `resource-name-endpoints.yaml` (endpoints для работы с ресурсом, до 400 строк)
  - `resource-name-models.yaml` (модели данных, до 400 строк)
  - `resource-name-operations.yaml` (специфичные операции, до 400 строк)
- Создать главный файл с ссылками на остальные через `$ref` или README.md с описанием структуры
