...
- `../auth/character-creation.yaml` - Создание персонажа (зависимость)
- `../lore/locations.yaml` - Локации (будущее)
- `../narrative/quests.yaml` - Квесты (будущее)
...
- **Стартовое снаряжение:** базовое оружие (пистолет Liberty), броня (уличная)
- **Начальный уровень:** 1
